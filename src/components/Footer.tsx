    ...
    <footer className="bg-[#1D1D1F] text-white pt-16 pb-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
          <div>
            <h3 className="text-xl font-medium tracking-wide mb-4">Océane Modest</h3>
            <p className="text-gray-400 text-sm leading-relaxed max-w-sm">
              {t("footer.desc")}
            </p>
          </div>
          <div>
            <h4 className="font-bold mb-4 text-sm tracking-wider">{t("footer.links")}</h4>
          ...
          <div>
            <h4 className="font-bold mb-4 text-sm tracking-wider">{t("footer.contact")}</h4>
            <ul className="space-y-2 text-sm text-gray-400">
